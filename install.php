		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="http://www.efwww.com">官网</a></li>
					<li role="presentation"><a href="http://www.efwww.com">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v1.4.4 &copy; 2017 <a href="http://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//www.efwww.com"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="技术支持" title="技术支持"></a>
						</label>

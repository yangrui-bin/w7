...
class Newrelease_EweiShopV2Page extends PluginWebPage 
{
	...
	public function submit() 
	{
		...
		load()->func("communication");
		ihttp_request(EWEI_SHOPV2_AUTH_WXAPP . "generate/upload?id=" . $auth["id"], array( "version" => $version, "describe" => $describe, "tabBar" => $tabBar, "ticket" => $ticket ), array( "Content-Type" => "application/x-www-form-urlencoded" ), 3);

		...
		public function sendMessage($openid = "", $data = array( ), $message_type = "") 
		{
			...
			else 
			{
				if( $message_type == TM_DIVIDEND_APPLY && empty($usernotice["dividend_apply"]) ) 
				{
					...
					$message = array( "first" => array( "value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["dividend"] . "提现申请已提交", "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "提现申请提交通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "您的佣金提现申请已提交", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
					$toopenid = $openid;
					$datas[] = array( "name" => "昵称", "value" => $member["nickname"] );
				...
				else 
				{
					if( $message_type == TM_DIVIDEND_CHECK && empty($usernotice["dividend_check"]) ) 
					{
						...
						$message = array( "first" => array( "value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["dividend"] . "提现申请已审核通过", "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "提现申请审核通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "您的佣金提现申请审核完成", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
						$toopenid = $openid;
						$datas[] = array( "name" => "昵称", "value" => $member["nickname"] );
						$datas[] = array( "name" => "时间", "value" => $time );
						$datas[] = array( "name" => "金额", "value" => $data["dividend"] );
					...
					else 
					{
						...
						else 
						{
							if( $message_type == TM_DIVIDEND_BECOME && empty($usernotice["dividend_become"]) ) 
							{
								...
								$message = array( "first" => array( "value" => "亲爱的" . $member["nickname"] . "，恭喜您" . $set["texts"]["become"], "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "成为" . $set["texts"]["agent"] . "通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "成为分销商通知", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
								$toopenid = $openid;
							...
							else 
							{
								if( $message_type == TM_DIVIDEND_BECOME_SALER && empty($usernotice["dividend_become_saler"]) ) 
								{
									...
									$message = array( "first" => array( "value" => "您的商城会员" . $member["nickname"] . $set["texts"]["become"], "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "成为" . $set["texts"]["agent"] . "通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "成为队长通知", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
									$datas[] = array( "name" => "昵称", "value" => $data["nickname"] );
									$datas[] = array( "name" => "时间", "value" => date("Y-m-d H:i:s", $data["headstime"]) );
								}
								else 
								{
									if( $message_type == TM_DIVIDEND_APPLYMONEY && empty($usernotice["dividend_applymoney"]) ) 
									{
										...
										$message = array( "first" => array( "value" => "亲爱的管理员您有一条新的" . $set["texts"]["dividend"] . "提现申请", "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "已提交", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "您的商城会员提交了一笔提现，\n金额:" . $data["dividend"] . " \n 时间:" . $time . "\n 提现方式:" . $data["type"], "color" => "#000000" ), "remark" => array( "value" => "\n请您注意审核团队分红的分红提现申请，及时处理哦", "color" => "#000000" ) );
										$toopenid = $tm["openid"];
										$datas[] = array( "name" => "昵称", "value" => $member["nickname"] );
										$datas[] = array( "name" => "时间", "value" => $time );
										$datas[] = array( "name" => "金额", "value" => $data["dividend"] );
									...
									else 
									{
										if( $message_type == TM_DIVIDEND_DOWNLINE_BECOME && empty($usernotice["dividend_downline_become"]) ) 
										{
											...
											$message = array( "first" => array( "value" => "您的团员" . $member["nickname"] . "已成为队长", "color" => "#ff0000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "keyword2" => array( "title" => "处理进度", "value" => "团员成为队长通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "您的团员在" . $time . "成为队长，他的下线不在为您提供分红", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );

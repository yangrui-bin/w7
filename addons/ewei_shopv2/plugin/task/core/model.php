...
class TaskModel extends PluginModel 
{
	...
	public function taskPickMessage($openid, $record) 
	{
		...
		$message = array( 'first' => array('value' => '亲爱的' . $record['nickname'] . '，恭喜您成功领取任务。', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => $type['type_name'], 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => (('截止时间：' . $record['stoptime']) == '0000-00-00 00:00:00' ? '无限制' : substr($record['stoptime'], 0, 16) . "\n" . '完成任务可获得丰厚奖励，赶快去完成任务吧~~'), 'color' => '#000000') );
	...
	public function taskProgressMessage($openid, $record) 
	{
		$tag = 'task_progress';
		$type = $this->getTaskType($record['tasktype']);
		$message = array( 'first' => array('value' => '任务最新进度', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => $type['type_name'], 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '接取时间：' . date('Y-m-d H:i') . "\n" . '当前进度：' . $record['task_progress'] . '/' . $record['task_demand'] . "\n" . '完成任务可获得丰厚奖励，赶快去完成任务吧~~', 'color' => '#000000') );
		$url = mobileUrl('task.detail', array('rid' => $record['id']), 1);
		if (strexists($url, '/addons/ewei_shopv2/')) 
		{
			$url = str_replace('/addons/ewei_shopv2/', '/', $url);
	...
	public function taskFinishMessage($openid, $record) 
	{
		$tag = 'task_finish';
		$type = $this->getTaskType($record['tasktype']);
		$message = array( 'first' => array('value' => '恭喜！您的任务已完成', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => $type['type_name'], 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '如有疑问请联系在线客服', 'color' => '#000000') );
	...
	public function posterPickMessage($openid, $record) 
	{
		...
		$message = array( 'first' => array('value' => '任务接取通知', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => '海报任务', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '领取时间：' . substr($record['picktime'], 0, 16) . "\n" . '截止时间：' . substr($record['stoptime'], 0, 16) . "\n" . '这是您的专属任务海报，快推出去让大家知道吧~~', 'color' => '#000000') );
		$url = mobileUrl('task.detail', array('rid' => $record['id']), 1);
		if (strexists($url, '/addons/ewei_shopv2/')) 
		{
			$url = str_replace('/addons/ewei_shopv2/', '/', $url);
	...
	public function posterProgressMessage($openid, $record) 
	{
		...
		$message = array( 'first' => array('value' => $record['niackname'] . '关注了您的海报，为您增加了1 点人气。', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => '海报任务', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '当前进度：' . $record['task_progress'] . '/' . $record['task_demand'] . "\n" . '扫描关注：' . $this_member['nickname'] . "\n" . '扫描时间：' . date('Y-m-d H:i') . '如有疑问请联系在线客服', 'color' => '#000000') );
	...
	public function posterFinishMessage($openid, $record) 
	{
		...
		$message = array( 'first' => array('value' => '您的任务已经完成！', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => '海报任务', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '快去查看您的奖励吧~~', 'color' => '#000000') );
		$url = mobileUrl('task.reward', NULL, 1);
		if (strexists($url, '/addons/ewei_shopv2/')) 
		{
			$url = str_replace('/addons/ewei_shopv2/', '/', $url);
	...
	public function taskPosterFollowMessage($openid, $record, $nickname = '') 
	{
		...
		$message = array( 'first' => array('value' => '您关注了' . $record['niackname'] . '的海报', 'color' => '#ff0000'), 'keyword2' => array('title' => '处理进度', 'value' => $record['tasktitle'], 'color' => '#000000'), 'keyword3' => array('title' => '处理内容', 'value' => '海报任务', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '快去查看您的奖励吧~~', 'color' => '#000000') );
		$url = mobileUrl('task.reward', NULL, 1);
		if (strexists($url, '/addons/ewei_shopv2/')) 
		{
			$url = str_replace('/addons/ewei_shopv2/', '/', $url);
